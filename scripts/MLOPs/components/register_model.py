...
from scripts.MLOPs.utils import model_wrapper
from scripts.MLOPs.utils.model_wrapper import YoloWrapper
            ...
            for metrics in metrics_reader:
                ...
                for key, value in metrics.items():
                    ...
                    try:
                        ...
                        logger.info(f"ValueError: Could not convert {value} to float.")
